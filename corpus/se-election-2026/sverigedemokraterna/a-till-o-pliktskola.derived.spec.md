...
status: draft
updated: 2026-08-23
summary: Skolplikt utsträcks till alla barn som vistas i landet, men politiken namnger varken sanktion, myndighet eller hur många barn det gäller.
jurisdiction: SE
sources:
  - title: Pliktskola
...
assumptions:
  ...
  - stärkt kontroll utan namngivet verktyg kan bli allt från brev till viten; politiken väljer inte
  - vårdnadshavares ansvar biter bara om någon myndighet får ett tydligt uppdrag att ingripa
  - politiken är för kort för att skilja på barn som aldrig skrivits in och barn som skolkar efter inskrivning
---

# Our understanding

> Plikten ska gälla varje barn som vistas i landet, och någon ska se till att den följs. Politiken säger inte vem som kontrollerar, med vilket tvång, eller hur många barn det rör. Utan folkbokföring och utan sanktion är kontrollen ett mål, inte en mekanism.
...
And politiken säger inte hur barn utan folkbokföring hittas
...
Then politiken säger inte om vite, socialtjänst eller polisanmälan följer
