---
type: spec
id: green-manifesto-2026-welfare-of-animals-derived
...
derivesFrom: green-manifesto-2026-welfare-of-animals
assumptions:
...
Scenario: A Commissioner for Animals and independent ministry are created
Given farmed animals suffering because standards meant to protect them are not upheld
...
Then goods that fail the local bar are kept out or forced to upgrade
Outcome domestic standards are not undercut by weaker imports
But compliance cost at the border falls on importers and then on buyers
