...
title: "Next billion customers read as a system: a market-size claim without contracted demand or named agreements"
status: draft
updated: 2026-08-21
summary: Nearly one billion potential customers is the size of target markets, not signed demand; doubling exports by 2034 is a goal without instruments on this policy; which agreements come first is unnamed.
jurisdiction: NZ
sources:
...
assumptions:
  - population or market size in a region is not the same as customers who will buy New Zealand goods; access still needs agreements, logistics and demand
  - a doubling goal without named agreements, budgets or barrier cuts on this policy is a destination, not a delivery path
  - Europe, South America, Asia and Africa name continents, not counterparties, so sequencing and coverage stay open
...
Scenario: Nearly one billion is read as demand
Given trade supports one in four New Zealand jobs today
When New Zealand businesses are connected with nearly one billion potential new customers
