...
clusters:
  - energy-power
money: named-figure
sourcePath: corpus/nz-election-2026/green/green_party_launches_plan_to_cut_power_bills_and_take_power_back_from_the_big_energy_companies.md
sourceDigest: "sha256-9ca17fbbf2f96ab0"
gaps:
  - expected bill savings per household are not stated as a policy guarantee
  - how fair export prices for rooftop solar would be set is not stated
  - dry-year firming capacity type and scale for Kiwipower are not locked in
  - no timetable beyond solar on public homes within four years and a 6 month loan start sketch
---
...
Scenario: Kiwipower is established and household energy upgrades begin
Given four big power companies controlling over 85 percent of the market
And 200,000 households unable to afford to heat their homes
When Kiwipower is established as a publicly owned entity
And zero-interest clean energy loans are provided to install solar and batteries
And a renters' right to solar is established and plug-in solar is legalised
And Warmer Kiwi Homes expands to cover more upgrades including gas transitions
Then new renewable generation and dry-year firming are invested in without a billion-dollar LNG facility
Output $980 million appropriation for Kiwipower over four years
And $200 million for community-owned renewable energy
And $80 million for renewable energy for Māori housing
And $969.8 million for Warmer Kiwi Homes
And $421.2 million for zero-interest loans
And solar on more than half of all public homes within four years
Outcome household power bills are lower and communities hold more control over energy
