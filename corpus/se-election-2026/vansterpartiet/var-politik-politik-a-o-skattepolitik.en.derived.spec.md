...
Given sick pay, unemployment and sickness pensions are taxed more heavily than wages today in the policy's telling
...
But the kronor gain per person is unknown until the rate schedule exists
