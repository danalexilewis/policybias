---
type: spec
id: green-manifesto-2026-energy-derived
title: "Energy manifesto read as a system: new institutions without a published price tag"
status: draft
updated: 2026-08-21
summary: A renewable energy agency, fossil extraction ban and single regulator change market rules and ownership paths, but this policy states no dollar amounts, so fiscal scale and bill effects cannot be sized here.
jurisdiction: NZ
sources:
  - title: Energy
...
clusters:
  - energy-power
money: no-figure
sourcePath: corpus/nz-election-2026/green/manifesto_2026_energy.md
derivesFrom: green-manifesto-2026-energy
assumptions:
  - a renewable energy infrastructure agency with a security-of-supply duty is a standing public body whose budget and balance-sheet powers are not on this policy
  - banning new fossil extraction and cancelling the LNG terminal closes those supply paths; any replacement capacity must come from renewables or imports the policy does not cost
  - a single energy regulator and a Ministry for Energy are institutional merges; transition cost and lost continuity are not stated
  - we introduce no figure, because the policy contains none to work from
sourceDigest: "sha256-5b03cad4f84915da"
---
