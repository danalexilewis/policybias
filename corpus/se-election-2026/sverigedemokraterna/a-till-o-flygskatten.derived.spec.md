...
status: draft
updated: 2026-08-23
summary: Avskaffandet tar bort ett pris på utrikesflyg; politiken hävdar noll klimatnytta och högre konkurrenskraft men visar varken utsläpp, linjer eller statsintäkter.
jurisdiction: SE
sources:
  - title: Flygskatten
...
assumptions:
  ...
  - klimatmål utan detta styrmedel kräver antingen andra styrmedel eller att målen missas; politiken nämner inget alternativ
---

# Our understanding

> Skatten på flyg är borta och ska förbli borta. Påståendet är att den inte minskade utsläppen och att den skadade konkurrenskraften. Inget av det är mätt på politiken. När priset tas bort bär den som flyger mindre av klimatkostnaden. Vem som bär den i stället sägs inte.
...
Then politiken pekar inte ut ett annat styrmedel mot flygets utsläpp
