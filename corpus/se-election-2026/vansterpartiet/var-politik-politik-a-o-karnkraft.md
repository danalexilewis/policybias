...
En varsam avveckling av kärnkraften behöver mötas av en gedigen utbyggnad av förnybara energislag. Tyvärr går utvecklingen åt motsatt håll, då regeringen satsar på att bygga ut kärnkraften i stället för att avveckla den. Detta trots att alla utredningar och kalkyler visar att det är dyrt, komplicerat och riskfyllt. Dessutom med en tidsrymd som inte löser de akuta energibehoven här och nu. Det är uppenbart att det har gått prestige i frågan; regeringen ska få fram ny kärnkraft oavsett kostnad eller nytta.

Även om kärnkraften är fossilfri och inte släpper ut koldioxid vid själva energiproduktionen är den långt ifrån miljövänlig och har många problem med miljöpåverkan, social påverkan och säkerhetsfrågor i hela produktionskedjan från uranbrytning till framställning av kärnbränsle, elproduktion och slutförvaring av det använda kärnbränslet. Utvinning av uran är dessutom en väldigt miljöförstörande verksamhet som innebär stora risker för omgivningen, grundvattnet, naturmiljön, och hälsan hos dem som arbetar i eller bor i närheten av urangruvorna.

Kärnkraften kräver avancerad teknik och är dyr och långsam att bygga. Flera samhällssektorers klimatomställning, bland annat industrins och transportsektorns, sker genom elektrifiering och vi ser därför ett kraftigt ökat elbehov framför oss. En kärnkraftsutbyggnad hinner inte svara mot detta behov under den korta tid vi har på oss att få ner våra utsläpp. Kärnkraftens produktionskostnader är så höga att den inte är fördelaktig att producera när man jämför med förnybara energikällor som vatten- och vindkraft.

Med kärnkraften följer också alltid en risk för olyckor. Även om allvarliga olyckor är ovanliga är konsekvenserna stora när de sker. Mindre olyckor och tillbud som utsätter både anställda och omgivningen för fara sker trots omfattande säkerhetsåtgärder och rutiner. De nödvändiga säkerhetskraven gör kärnkraftsproduktionen ännu dyrare än den annars skulle vara.
...
Läs mer om Vänsterpartiets uranpolitik  
[https://www.vansterpartiet.se/var-politik/politik-a-o/uranbrytning/](https://www.vansterpartiet.se/var-politik/politik-a-o/uranbrytning/)
