...
title: "Tertiary plan read as a system: an income entitlement and fees-free pathway without a price or date"
status: draft
updated: 2026-08-21
summary: Universal student income and fees-free are named as direction, not as a rate or commencement; debt write-off and polytechnic protection stay open until amounts and criteria appear.
jurisdiction: NZ
sources:
...
assumptions:
  ...
  - working towards fees-free and debt write-off is a pathway, not a commencement date or eligibility rule
  - protecting polytechnic campuses and staff from cuts needs a funding floor the page calls adequate without defining it
