...
assumptions:
  - moving from 7.3 times wages toward 3 times wages is a large fall in existing home values, which sitting owners absorb; the policy wants prices to drop but does not quantify the wealth transfer
...
But sitting owners, especially those who bought when prices were highest, carry the loss the policy is trying to create
