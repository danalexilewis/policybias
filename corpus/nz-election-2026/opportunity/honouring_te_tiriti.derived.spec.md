...
assumptions:
  - repeal returns the statute book to whatever sat underneath; if that underneath has already been replaced, repeal is not a full restore
  - devolution "with real resources" is a Budget line and a legal person; without those, it is a direction to officials
  - growing te reo teachers competes with the same teacher-pay pipeline as the education page
